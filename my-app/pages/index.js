...
export default function Home() {
  ...
  const getBalanceOfCryptDevTokens = async() => {
    try{
  ...
  const mintCryptoDevToken = async(amount) =>{
    try{
      ...
      await getBalanceOfCryptDevTokens()
      ...
      <div style={{display: "flex-col"}}>
        <div>
          ...
          <button className={styles.button} 
            ...
            onClick={() => mintCryptoDevToken}>Mint Tokens</button>
        </div>
        ...
        <div>
          ...
          {walletConnected ? 
            ...
            (<div>
              ...
              <div className={styles.description}>
                Overal {utils.formatEther(tokensMinted)} /10 000 have been minted
              </div>
              {renderButton()}
            </div>) : 
